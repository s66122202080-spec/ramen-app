...
const RAMEN_MENU = [
  ...
  },
  {
    ...
    name: 'จาจัง',
    nameKr: '짜장',
    nameFull: 'Samyang Jjajang Buldak',
    brand: 'Samyang',
    flavor: 'ซอสถั่วดำผัดเผ็ด',
    spiceLevel: 3,
    description: 'ผสมระหว่างจาจังเมียน (เส้นซอสถั่วดำ) กับความเผ็ดบูลดัก กลิ่นหอมซอสถั่วดำเข้มข้น เผ็ดกลางๆ รสชาติลึก เข้ากันสุดๆ',
    tags: ['เผ็ดกลาง', 'ซอสถั่วดำ', 'อร่อย'],
    color: '#2D2D2D',
    emoji: '⚫',
